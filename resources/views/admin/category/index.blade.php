        ...
        <div class="container">
            <div class="py-5">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-auto d-flex"><a href="{{route('admin.category.create')}}" class="btn btn-primary">New category</a></div>
                </div>
            </div>
            <div class="card">
                ...
                <table class="sa-datatables-init" data-order="[[ 1, &quot;asc&quot; ]]" data-sa-search-input="#table-search">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><img width="100px" height="100px" src="{{asset('storage/'.$category->image)}}" alt=""></td>
                        <td><a href="app-category.html" class="text-reset">{{$category->name}}</a></td>
                        <td>3</td>
                        <td>
                            @if ($category->status == 'published')
                            <div class="badge badge-sa-success">Visible</div>
                            @elseif ($category->status == 'hidden')
                            <div class="badge badge-sa-success">Hidden</div>
                            @else
                            <div class="badge badge-sa-success">Scheduled</div>
