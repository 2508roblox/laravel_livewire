                ...
                <div class="mb-6 pt-3">
                    <div class="row align-items-end">
                        <div class="col" style="background-image: url('https://transvelo.github.io/electro-html/2.0/assets/img/1920X422/img1.jpg'); background-position: center">
                           ...
                           $count++;
                              @endphp
                              <div class="tab-pane fade show  {{$number[$count] == 'one' ? 'active' :''}}" id="pills-{{$number[$count]}}-code-features" role="tabpanel"
                              ...
                              <div class="row align-items-end">
                                  ...
                                  <div class="col-lg-7" data-scs-animation-in="zoomIn"
                                      ...
                                      <img style="max-height: 310px" class="img-fluid rounded-lg" src="{{$slider->image ? asset('storage/'. $slider->image) :'client/img/724X360/img2.png' }}"
                            ...
                            <div class="bg-light max-width-216">
                               ...
                               @endphp
                                   <li class="nav-item mx-0">
                                    <a class="nav-link p-2 px-4 {{$number[$count] == 'one' ? 'active' :''}}" id="pills-{{$number[$count]}}-code-features-tab"
                                        data-toggle="pill" href="#pills-{{$number[$count]}}-code-features" role="tab"
                                        aria-controls="pills-{{$number[$count]}}-code-features" aria-selected="true">
                                ...
                                <div class="product-item__outer h-100">
                                    <div class="product-item__inner bg-white px-wd-3 p-2 p-md-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <div class="mb-2">
                                                <a href="{{ url('/shop') }}" class="d-block text-center"><img
                                                        class="img-fluid" src="client/img/212X200/img2.jpg"
                                                        alt="Image Description"></a>
                                            </div>
                                            <div class="flex-center-between mb-1">
                                                <div class="prodcut-price">
