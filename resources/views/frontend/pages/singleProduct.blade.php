                    ...
                    <div class="mb-2">
                        <div class="border-bottom mb-3 pb-md-1 pb-3">
                            ...
                            <div class="d-md-flex align-items-center">
                                <a href="#" class="max-width-150 ml-n2 mb-2 mb-md-0 d-block"><img class="img-fluid" src="{{asset('client/img/200X60/img1.png')}}" alt="Image Description"></a>
                ...
                <div class="tab-content" id="Jpills-tabContent">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="pt-lg-8 pt-xl-10">
                                    ...
                                    <p class="mb-6">Integer bibendum aliquet ipsum, in ultrices enim sodales sed. Quisque ut urna vitae lacus laoreet malesuada eu at massa. Pellentesque nibh augue, pellentesque nec dictum vel, pretium a arcu. Duis eu urna suscipit,
                            ...
                            <div class="col-md-6 text-right">
                                <img class="img-fluid mr-n4 mr-lg-n10" src="{{asset('client/img/580X580/img1.jpg')}}" alt="Image Description">
                            </div>
                            <div class="col-md-6 text-left">
                                <img class="img-fluid ml-n4 ml-lg-n10" src="{{asset('client/img/580X580/img2.jpg')}}" alt="Image Description">
                            </div>
                    ...
                    <div class="tab-pane fade" id="Jpills-four-example1" role="tabpanel" aria-labelledby="Jpills-four-example1-tab">
                        ...
                        <div class="border-bottom border-color-1 pb-4 mb-4">
                            ...
                            <p class="text-gray-90">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Suspendisse eget facilisis odio. Duis sodales augue eu tincidunt faucibus. Etiam justo ligula, placerat ac augue id, volutpat
                                porta dui.</p>
