                ...
                <div class="container">
                            ...
                            <div class="col">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="pills-one-code-features" role="tabpanel" aria-labelledby="pills-one-code-features-tab">
                                        <div class="row align-items-end">
                                            <div class="col-lg-5">
                                                <h1 class="font-size-58 text-lh-57 mb-3 font-weight-light" data-scs-animation-in="fadeInUp">
                                                ...
                                                <a href="{{url('/shop')}}" class="btn btn-primary transition-3d-hover rounded-lg font-weight-normal py-2 px-md-7 px-3 font-size-16" data-scs-animation-in="fadeInUp" data-scs-animation-delay="300">
                                                        Start Buying
                                                    </a>
                                            </div>
                                            <div class="col-lg-7" data-scs-animation-in="zoomIn" data-scs-animation-delay="500">
                                                <img class="img-fluid rounded-lg" src="client/img/724X360/img2.png" alt="Image Description">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="pills-two-code-features" role="tabpanel" aria-labelledby="pills-two-code-features-tab">
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-lg-7" data-scs-animation-in="zoomIn" data-scs-animation-delay="500">
                                                <img class="img-fluid rounded-lg" src="client/img/724X360/img1.png" alt="Image Description">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="pills-three-code-features" role="tabpanel" aria-labelledby="pills-three-code-features-tab">
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-lg-7" data-scs-animation-in="zoomIn" data-scs-animation-delay="500">
                                                <img class="img-fluid rounded-lg" src="client/img/724X360/img3.png" alt="Image Description">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="pills-four-code-features" role="tabpanel" aria-labelledby="pills-four-code-features-tab">
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-lg-7" data-scs-animation-in="zoomIn" data-scs-animation-delay="500">
                                                <img class="img-fluid rounded-lg" src="client/img/724X360/img4.png" alt="Image Description">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="mb-4 position-relative">
                        <div class="js-slick-carousel u-slick u-slick--gutters-0 position-static overflow-hidden u-slick-overflow-visble pb-5 pt-2 px-1" data-arrows-classes="u-slick__arrow u-slick__arrow--flat u-slick__arrow-centered--y rounded-circle" data-arrow-left-classes="fas fa-arrow-left u-slick__arrow-inner u-slick__arrow-inner--left ml-lg-2 ml-xl-n3"
                            data-arrow-right-classes="fas fa-arrow-right u-slick__arrow-inner u-slick__arrow-inner--right mr-lg-2 mr-xl-n3" data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-3 pt-1"
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner bg-white px-wd-3 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img1.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    ...
                                                    <div class="d-none d-xl-block prodcut-add-cart">
                                                        <a href="{{url('/shop')}}" class="btn-add-cart btn-primary transition-3d-hover"><i class="ec ec-add-to-cart"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner bg-white px-wd-3 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img2.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">$685,00</div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner bg-white px-wd-3 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img3.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">$685,00</div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner bg-white px-wd-3 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img4.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">$685,00</div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner bg-white px-wd-3 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img5.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">$685,00</div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner bg-white px-wd-3 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img6.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">$685,00</div>
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner bg-white px-wd-3 p-2 p-md-3">
                                            <div class="product-item__body pb-xl-2">
                                                ...
                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img7.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">$685,00</div>
        ...
        <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 mb-xl-0">
                        <a href="../shop/shop.html" class="d-block">
                                <img class="img-fluid" src="client/img/690X150/img1.jpg" alt="Image Description">
                            </a>
                    </div>
                    <div class="col-md-6 mb-4 mb-xl-0">
                        <a href="../shop/shop.html" class="d-block">
                                <img class="img-fluid" src="client/img/690X150/img2.jpg" alt="Image Description">
                            </a>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5">
                <div class="position-relative">
                    <div class="js-slick-carousel u-slick u-slick--gutters-0 position-static overflow-hidden u-slick-overflow-visble pb-5 pt-2 px-1" data-arrows-classes="d-none d-xl-block u-slick__arrow-normal u-slick__arrow-centered--y rounded-circle text-black font-size-30 z-index-2"
                        data-arrow-left-classes="fa fa-angle-left u-slick__arrow-inner--left left-n16" data-arrow-right-classes="fa fa-angle-right u-slick__arrow-inner--right right-n20" data-pagi-classes="d-xl-none text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-3 pt-1"
            ...
            <div class="mb-4">
                ...
                <div class="position-relative z-index-2">
                    <div class=" d-flex justify-content-between border-bottom border-color-1 flex-lg-nowrap flex-wrap border-md-down-top-0 border-md-down-bottom-0 mb-4">
                        ...
                        <ul class="w-100 w-lg-auto nav nav-pills nav-tab-pill nav-tab-pill-fill mb-3 mb-lg-2 pt-3 pt-lg-0 border-top border-color-1 border-lg-top-0 align-items-center font-size-15 font-size-15-lg flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble pr-0"
                    ...
                    <div class="row">
                        <div class="col-md-auto col-md-5 col-xl-4 col-wd-3gdot3 mb-6 mb-md-0">
                            ...
                            <div class="p-3 border border-width-2 border-primary borders-radius-20 bg-white min-width-370">
                                ...
                                <div class="mb-2">
                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/320X300/img1.jpg" alt="Image Description"></a>
                                </div>
                                <h5 class="mb-2 font-size-14 text-center mx-auto text-lh-18"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Game Console Controller + USB 3.0 Cable</a></h5>
                                                    ...
                                                    <div class="product-item__outer h-100">
                                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                ...
                                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Video Camera 4k Waterproof</a></h5>
                                                                <div class="mb-2">
                                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img8.jpg" alt="Image Description"></a>
                                                                </div>
                                                                <div class="flex-center-between mb-1">
                                                                    <div class="prodcut-price">
                                                                        <div class="text-gray-100">$685,00</div>
                                                ...
                                                <div class="col-6 col-md-4 col-xl-3 col-wd-2gdot4 product-item remove-divider-md-lg">
                                                    <div class="product-item__outer h-100">
                                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Ultra Wireless S50 Headphones S50 with Bluetooth</a></h5>
                                                                <div class="mb-2">
                                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img5.jpg" alt="Image Description"></a>
                                                                </div>
                                                                <div class="flex-center-between mb-1">
                                                ...
                                                <div class="col-6 col-md-4 col-xl-3 col-wd-2gdot4 product-item remove-divider-xl">
                                                    <div class="product-item__outer h-100">
                                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Tablet White EliteBook Revolve 810 G2</a></h5>
                                                                <div class="mb-2">
                                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img2.jpg" alt="Image Description"></a>
                                                                </div>
                                                                <div class="flex-center-between mb-1">
                                                ...
                                                <div class="col-6 col-md-4 col-xl-3 col-wd-2gdot4 product-item remove-divider-wd">
                                                    <div class="product-item__outer h-100">
                                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Purple Solo 2 Wireless</a></h5>
                                                                <div class="mb-2">
                                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img3.jpg" alt="Image Description"></a>
                                                                </div>
                                                                <div class="flex-center-between mb-1">
                                                ...
                                                <div class="col-6 col-md-4 col-xl-3 col-wd-2gdot4 product-item remove-divider-md-lg">
                                                    <div class="product-item__outer h-100">
                                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Smartphone 6S 32GB LTE</a></h5>
                                                                <div class="mb-2">
                                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img4.jpg" alt="Image Description"></a>
                                                                </div>
                                                                <div class="flex-center-between mb-1">
                                                ...
                                                <div class="col-6 col-md-4 col-xl-3 col-wd-2gdot4 product-item">
                                                    <div class="product-item__outer h-100">
                                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Widescreen NX Mini F1 SMART NX</a></h5>
                                                                <div class="mb-2">
                                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img5.jpg" alt="Image Description"></a>
                                                                </div>
                                                                <div class="flex-center-between mb-1">
                                                ...
                                                <div class="col-6 col-md-4 col-xl-3 col-wd-2gdot4 product-item remove-divider-xl">
                                                    <div class="product-item__outer h-100">
                                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Full Color LaserJet Pro M452dn</a></h5>
                                                                <div class="mb-2">
                                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img6.jpg" alt="Image Description"></a>
                                                                </div>
                                                                <div class="flex-center-between mb-1">
                                                ...
                                                <div class="col-6 col-md-4 col-xl-3 col-wd-2gdot4 product-item remove-divider-md-lg d-xl-none d-wd-block remove-divider-xl">
                                                    <div class="product-item__outer h-100">
                                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">GameConsole Destiny  Special Edition</a></h5>
                                                                <div class="mb-2">
                                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img7.jpg" alt="Image Description"></a>
                                                                </div>
                                                                <div class="flex-center-between mb-1">
                                                ...
                                                <div class="col-6 col-md-4 col-xl-3 col-wd-2gdot4 product-item d-md-none d-wd-block remove-divider-wd">
                                                    <div class="product-item__outer h-100">
                                                        <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                                            <div class="product-item__body pb-xl-2">
                                                                <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                                <h5 class="mb-1 product-item__title"><a href="{{url('/shop')}}" class="text-blue font-weight-bold">Camera C430W 4k Waterproof</a></h5>
                                                                <div class="mb-2">
                                                                    <a href="{{url('/shop')}}" class="d-block text-center"><img class="img-fluid" src="client/img/212X200/img8.jpg" alt="Image Description"></a>
                                                                </div>
                                                                <div class="flex-center-between mb-1">
            ...
            <div class="mb-4">
                ...
                <div class="js-slick-carousel u-slick overflow-hidden u-slick-overflow-visble pt-3 pb-6 px-1" data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-4" data-slides-show="7" data-slides-scroll="1"
                    data-responsive='[{
                          "breakpoint": 1400,
                          "settings": {
                            "slidesToShow": 5
            ...
            <div class="mb-8">
                <a href="../shop/shop.html" class="d-block text-gray-90">
                    <div class="" style="background-image: url(client/img/1400X206/img1.jpg);">
            ...
            <div class="mb-6">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg">
                        <a href="../shop/shop.html" class="d-block"><img class="img-fluid" src="client/img/390X370/img1.jpg" alt="Image Description"></a>
                    </div>
                    <div class="col-md-6 pl-md-0 col-lg-8gdot46">
                        ...
                        <div class="tab-content u-slick__tab overflow-hidden pr-0dot5" id="Dpills-tabContent">
                            <div class="tab-pane fade show active" id="Dpills-one-example1" role="tabpanel" aria-labelledby="Dpills-one-example1-tab">
                                <div class="js-slick-carousel u-slick position-static u-slick-overflow-visble pb-7 pt-1 px-1" data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-3 mt-md-0" data-slides-show="5" data-slides-scroll="1"
                                    data-responsive='[{
                                          "breakpoint": 1400,
                                          "settings": {
                                            "slidesToShow": 4
            ...
            <div class="mb-6">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg">
                        <a href="../shop/shop.html" class="d-block"><img class="img-fluid" src="client/img/390X270/img1.jpg" alt="Image Description"></a>
                    </div>
                    <div class="col-md-6 pl-md-0 col-lg-8gdot46">
                        <!-- Tab Content -->
                        <div class="tab-content u-slick__tab overflow-hidden pr-0dot5" id="Kpills-tabContent">
                            <div class="tab-pane fade show active" id="Kpills-one-example1" role="tabpanel" aria-labelledby="Kpills-one-example1-tab">
                                <div class="js-slick-carousel u-slick position-static overflow-hidden u-slick-overflow-visble pb-7 pt-2 px-1" data-pagi-classes="text-center right-0 bottom-1 left-0 u-slick__pagination u-slick__pagination--long mb-0 z-index-n1 mt-3 mt-md-0" data-slides-show="5"
                                    data-slides-scroll="1" data-responsive='[{
                                          "breakpoint": 1400,
                                          "settings": {
                                            "slidesToShow": 4
                                          }
            ...
            <div class="mb-11">
                <div class="row flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                    <div class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1">
                        <a href="../shop/shop.html" class="min-height-132 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                            <div class="col-6 col-xl-7 col-wd-6 pr-0">
                                <img class="img-fluid" src="client/img/246X176/img1.jpg" alt="Image Description">
                            </div>
                    ...
                    <div class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1">
                        <a href="../shop/shop.html" class="min-height-132 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                            <div class="col-6 col-xl-7 col-wd-6 pr-0">
                                <img class="img-fluid" src="client/img/246X176/img2.jpg" alt="Image Description">
                            </div>
                            <div class="col-6 col-xl-5 col-wd-6 pr-xl-4 pr-wd-3">
                                <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                    ...
                    <div class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1">
                        <a href="../shop/shop.html" class="min-height-132 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                            <div class="col-6 col-xl-7 col-wd-6 pr-0">
                                <img class="img-fluid" src="client/img/246X176/img3.jpg" alt="Image Description">
                            </div>
                            <div class="col-6 col-xl-5 col-wd-6 pr-xl-4 pr-wd-3">
                                <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                                    CATCH BIG <strong>DEALS</strong> ON THE CAMERAS
                    ...
                    <div class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1 d-xl-none d-wd-block">
                        <a href="../shop/shop.html" class="min-height-132 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                            <div class="col-6 col-xl-5 col-wd-6 pr-0">
                                <img class="img-fluid" src="client/img/190X150/img4.png" alt="Image Description">
                            </div>
                    ...
                    <div class="js-slick-carousel u-slick my-1" data-slides-show="5" data-slides-scroll="1" data-arrows-classes="d-none d-lg-inline-block u-slick__arrow-normal u-slick__arrow-centered--y" data-arrow-left-classes="fa fa-angle-left u-slick__arrow-classic-inner--left z-index-9"
                        ...
                        <div class="js-slide">
                            <a href="#" class="link-hover__brand">
                                    <img class="img-fluid m-auto max-height-50" src="client/img/200X60/img1.png" alt="Image Description">
                                </a>
                        </div>
                        <div class="js-slide">
                            <a href="#" class="link-hover__brand">
                                    <img class="img-fluid m-auto max-height-50" src="client/img/200X60/img2.png" alt="Image Description">
                                </a>
                        </div>
                        <div class="js-slide">
                            <a href="#" class="link-hover__brand">
                                    <img class="img-fluid m-auto max-height-50" src="client/img/200X60/img3.png" alt="Image Description">
                                </a>
                        </div>
                        <div class="js-slide">
                            <a href="#" class="link-hover__brand">
                                    <img class="img-fluid m-auto max-height-50" src="client/img/200X60/img4.png" alt="Image Description">
                                </a>
                        </div>
                        <div class="js-slide">
                            <a href="#" class="link-hover__brand">
                                    <img class="img-fluid m-auto max-height-50" src="client/img/200X60/img5.png" alt="Image Description">
                                </a>
                        </div>
                        <div class="js-slide">
                            <a href="#" class="link-hover__brand">
                                    <img class="img-fluid m-auto max-height-50" src="client/img/200X60/img6.png" alt="Image Description">
                                </a>
                        </div>
                    </div>
                </div>
